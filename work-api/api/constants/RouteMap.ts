...
export default {
    ...
    AI_GRAPH_NODE_DETAIL: ROUTE_BASE_URL + "/ai/graph/:graph/node/:node_id",
    AI_GRAPH_LINK_DETAIL: ROUTE_BASE_URL + "/ai/graph/:graph/link/:link_id",
    AI_GRAPH_DATA: ROUTE_BASE_URL + "/ai/graph/:graph/data",
    AI_GRAPH_CHAT: ROUTE_BASE_URL + "/ai/graph/:graph/chat",
    AI_GRAPH_DOCUMENT: ROUTE_BASE_URL + "/ai/graph/:graph/document",
    AI_GRAPH_DOCUMENT_DETAIL: ROUTE_BASE_URL + "/ai/graph/:graph/document/:document_id",
    AI_GRAPH_DATA_TEXT: ROUTE_BASE_URL + "/ai/graph/:graph/data/text",
    AI_GRAPH_DATA_FILE: ROUTE_BASE_URL + "/ai/graph/:graph/data/file",
    ...
    AI_GRAPH_MULTI_LINK_DETAIL: ROUTE_BASE_URL + "/ai/graph/:graph/workspace/:workspace/link/:link_id",
