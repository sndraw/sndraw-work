...
class RolePermissionsService {
    ...
    static async findRecordById(id: Identifier | undefined) {
        ...
        const result = await RolePermissionsModel.findByPk(id);
        return result;
    }
    ...
    static async addRecord(data: any) {
        ...
        try {
            const result = await RolePermissionsModel.create({
                ...data,
    ...
    static async updateRecord(id: any, data: any) {
        ...
        const result = await RolePermissionsModel.update(
            {
                ...data,
                updatedAt: new Date().getTime(),
            },
    ...
    static async deleteRecord(id: any) {
        ...
        const result = await RolePermissionsModel.destroy({
            where: {
                id: id,
            },
        });
